...
public class StorageStateSUN02 {
    public static void main(String[] args) {
      ...
      BrowserContext browserContext=  browser.newContext(new Browser.NewContextOptions().setStorageStatePath(Paths.get("TestStateSUN.json")));
